...
namespace StudentApi.DataSimulation
{
    public class StudentDataSimulation
    {
        ...
        public static readonly List<Student> StudentsList = new()
        {
            // Initialize the list with some student objects.
            new() { Id = 1, Name = "Ali Ahmed", Age = 20, Grade = 88 },
            new() { Id = 2, Name = "Fadi Khail", Age = 22, Grade = 77 },
            new() { Id = 3, Name = "Ola Jaber", Age = 21, Grade = 66 },
            new() { Id = 4, Name = "Alia Maher", Age = 19, Grade = 44 }
        };
    }
}
